...
import com.rsel.model.Vo.MetaVoExample;
...
public class MetaServiceImpl implements IMetaService {
    ...
    public void saveMeta(String type, String name, Integer mid) {
        if (StringUtils.isNotBlank(type) && StringUtils.isNotBlank(name)) {
            ...
            MetaVo metas;
            if (metaVos.size() != 0) {
                throw new TipException("Already exists");
            } else {
                metas = new MetaVo();
                metas.setName(name);
                if (null != mid) {
                 ...
                 // Update the categories of the original article
    ...
    public void saveMetas(Integer cid, String names, String type) {
        if (null == cid) {
            throw new TipException("Project association id cannot be empty");
        }
    ...
    private void saveOrUpdate(Integer cid, String name, String type) {
        ...
        if (metaVos.size() == 1) {
            ...
            throw new TipException("Query multiple data");
        } else {
            metas = new MetaVo();
            metas.setSlug(name);
            metas.setName(name);
