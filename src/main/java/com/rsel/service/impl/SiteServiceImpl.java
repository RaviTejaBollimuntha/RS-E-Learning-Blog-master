...
import com.rsel.controller.admin.AttachController;
import com.rsel.dao.AttachVoMapper;
...
public class SiteServiceImpl implements ISiteService {
    ...
    public BackResponseBo backup(String bk_type, String bk_path, String fmt) throws Exception {
        ...
        if (bk_type.equals("db")) {
         ...
         // Delete the backup file after 10 seconds
